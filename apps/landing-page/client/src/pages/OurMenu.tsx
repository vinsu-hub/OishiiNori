...
export default function OurMenu() {
  ...
  return <div className="on-site"><SiteNav /><main tabIndex={-1} id="main-content" ref={revealRef}>
    <section className="on-catering-hero on-container on-menu-hero"><p className="on-label">OISHII NORI / ON THE MENU</p><h1>FIND YOUR<br /><span>NEXT CRAVING.</span></h1><p>Browse the kitchen’s menu, then order your favourites online.</p><a className="on-button" href="/menu">Order now <span className="on-arrow" aria-hidden="true">↗</span></a></section>
