"""One-off migration apply: 0052_customer_reviews.sql. See
...
try:
    ...
    conn.commit()
    print("Applied 0052_customer_reviews.sql successfully.")
    print(f"reviews columns: {cols}")
except Exception:
    conn.rollback()
    raise
finally:
